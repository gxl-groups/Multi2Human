...
class Transformer(nn.Module):
    ...
    def __init__(self, H):
        ...
        self.block_size = 512 #  H.block_size
        ...
        self.tok_emb = nn.Embedding(self.vocab_size, self.n_embd) # 2049,512
    ...
    def forward(self, idx, t=None):
        ...
        token_embeddings = self.tok_emb(idx) # idx 2*512 tokens_emb 2*512*512
        ...
        t = token_embeddings.shape[1]  # 512
