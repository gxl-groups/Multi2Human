...
def instantiate_from_config(config):
    ...
    # image_synthesis.data.cub200_dataset.Cub200Dataset
    # 'image_synthesis.modeling.models.dalle'    DALLE
    # 'image_synthesis.modeling.codecs.image_codec.taming_gumbel_vqvae' 'TamingGumbelVQVAE'
